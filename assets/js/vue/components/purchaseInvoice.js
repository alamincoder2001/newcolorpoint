                        ...
                        <table _a584de>
                            ...
                            <tbody>
                                <tr v-for="(product, sl) in cart">
                                    ...
                                    <td v-if="product.Unit_Name == 'SFT'">{{ parseInt(product.PurchaseDetails_TotalQuantity/product.roll_per_sft) + ' Roll' }}  {{ product.PurchaseDetails_TotalQuantity % product.roll_per_sft + ' SFT' }}</td>
                                    <td v-else>{{ product.PurchaseDetails_TotalQuantity }} {{ product.Unit_Name }}</td>
