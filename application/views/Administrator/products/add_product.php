		...
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom: 15px;">
			<div class="col-md-5 col-md-offset-1">
				...
				<div class="form-group">
					...
					<div class="col-md-1" style="padding:0;margin-left: -15px;"><a href="/add-size" target="_blank" class="add-button"><i class="fa fa-plus"></i></a></div>

				</div>

				<!-- <div class="form-group clearfix">
					<label class="control-label col-md-4">SFT / Roll:</label>
					<div class="col-md-7">
						<input type="text" v-model.number="product.sft_per_roll" class="form-control">
					</div>
				</div> -->
	...
	new Vue({
		...
		methods: {
			...
			saveProduct() {
				...
				this.product.size_id = this.selectedSize.size_id;
