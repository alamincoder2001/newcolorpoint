					...
					<tbody>
						<template v-for="sale in sales">
							<tr>
								...
								<td v-if="sale.saleDetails[0].Unit_Name == 'SFT'" style="text-align:center;">{{ parseInt(sale.saleDetails[0].SaleDetails_TotalQuantity/sale.saleDetails[0].roll_per_sft) + ' Roll' }} {{ sale.saleDetails[0].SaleDetails_TotalQuantity % sale.saleDetails[0].roll_per_sft + ' SFT' }}</td>

								<td v-else style="text-align:center;">{{ sale.saleDetails[0].SaleDetails_TotalQuantity }} {{ sale.saleDetails[0].Unit_Name }}</td>
							...
							<tr v-for="(product, sl) in sale.saleDetails.slice(1)">
								...
								<td v-if="product.Unit_Name == 'SFT'" style="text-align:center;">{{ parseInt(product.SaleDetails_TotalQuantity/product.roll_per_sft) + ' Roll' }} {{ product.SaleDetails_TotalQuantity % product.roll_per_sft + ' SFT' }}</td>

								<td v-else style="text-align:center;">{{ product.SaleDetails_TotalQuantity }} {{ product.Unit_Name }}</td>
