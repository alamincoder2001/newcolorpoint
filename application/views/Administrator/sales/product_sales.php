		...
		<div class="widget-box">
			...
			<div class="widget-body">
				<div class="widget-main">
					...
					<div class="row">
						<div class="col-sm-5">
							<div class="form-group clearfix" style="margin-bottom: 8px;display:none">
						...
						<div class="col-sm-5">
							<form v-on:submit.prevent="addToCart">
								...
								<div class="form-group" style="display:none" :style="{display:selectedProduct.Unit_Name == 'SFT' ? '' : 'none'}">
									<label class="col-xs-3 control-label no-padding-right"> Roll </label>
									<div class="col-xs-9">
										<div class="row">
		...
		methods: {
			...
			productTotal() {
				...
				if (this.selectedProduct.Unit_Name == 'SFT') {
					...
					this.selectedProduct.total = ((this.roll * this.selectedProduct.roll_per_sft) + +this.sft) * this.selectedProduct.Product_SellingPrice;
				} else {
