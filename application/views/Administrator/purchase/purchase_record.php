					...
					<tbody>
						<template v-for="purchase in purchases">
							<tr>
								...
								<td v-if="purchase.purchaseDetails[0].Unit_Name == 'SFT'" style="text-align:center;">{{ parseInt(purchase.purchaseDetails[0].PurchaseDetails_TotalQuantity/purchase.purchaseDetails[0].roll_per_sft) + ' Roll' }} {{ purchase.purchaseDetails[0].PurchaseDetails_TotalQuantity % purchase.purchaseDetails[0].roll_per_sft + ' SFT' }}</td>

								<td v-else style="text-align:center;">{{ purchase.purchaseDetails[0].PurchaseDetails_TotalQuantity }} {{ purchase.purchaseDetails[0].Unit_Name }}</td>
							...
							<tr v-for="(product, sl) in purchase.purchaseDetails.slice(1)">
								...
								<td v-if="product.Unit_Name == 'SFT'" style="text-align:center;">{{ parseInt(product.PurchaseDetails_TotalQuantity/product.roll_per_sft) + ' Roll' }} {{ product.PurchaseDetails_TotalQuantity % product.roll_per_sft + ' SFT' }}</td>

								<td v-else style="text-align:center;">{{ product.PurchaseDetails_TotalQuantity }} {{ product.Unit_Name }}</td>
